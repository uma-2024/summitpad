...
const Steps = () => {
      ...
      if (windowWidth > 768) {
        ...
        const applyStyle = (phaseRef, arrowRef, svgRef, isSecondArrow = false) => {
          if (phaseRef.current) {
            ...
            if (top < windowHeight) {
              setTimeout(() => {
                phaseRef.current.style.background = 'linear-gradient(87deg, rgba(255, 28, 238, 0.26) -4.79%, rgba(81, 106, 255, 0.28) 91.73%)';
  ...
  return (
    <div className="steps-container">
      <h2>Steps to Stack at <span>SUMMITpad</span></h2>
      <div className='phase-container'>
        <div className='phase-arrow'>
          <div className="phase" ref={phase1Ref}>
            ...
            <p>Signup</p>
            <p>Connect your wallet with SUMMITPAD</p>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" width="598" height="112" viewBox="0 0 610 102" fill="none" className="arrow-svg" ref={svg1Ref}>
            ...
            <g transform="translate(575, 131) rotate(270)">
              <path d="M2.13627 18.399C0.287694 16.9985 0.287694 14.22 2.13627 12.8195L16.9082 1.62801C19.5138 -0.346004 23.163 2.01228 22.4336 5.19875L20.1803 15.0425C20.0257 15.7176 20.0291 16.4194 20.1902 17.093L22.2924 25.8857C23.0564 29.0813 19.3937 31.4735 16.7747 29.4893L2.13627 18.399Z" fill=""/>
              <path d="M2.13627 18.399C0.287694 16.9985 0.287694 14.22 2.13627 12.8195L16.9082 1.62801C19.5138 -0.346004 23.163 2.01228 22.4336 5.19875L20.1803 15.0425C20.0257 15.7176 20.0291 16.4194 20.1902 17.093L22.2924 25.8857C23.0564 29.0813 19.3937 31.4735 16.7747 29.4893L2.13627 18.399Z" fill=""/>
              <path d="M2.13627 18.399C0.287694 16.9985 0.287694 14.22 2.13627 12.8195L16.9082 1.62801C19.5138 -0.346004 23.163 2.01228 22.4336 5.19875L20.1803 15.0425C20.0257 15.7176 20.0291 16.4194 20.1902 17.093L22.2924 25.8857C23.0564 29.0813 19.3937 31.4735 16.7747 29.4893L2.13627 18.399Z" stroke=""/>
              <path d="M2.13627 18.399C0.287694 16.9985 0.287694 14.22 2.13627 12.8195L16.9082 1.62801C19.5138 -0.346004 23.163 2.01228 22.4336 5.19875L20.1803 15.0425C20.0257 15.7176 20.0291 16.4194 20.1902 17.093L22.2924 25.8857C23.0564 29.0813 19.3937 31.4735 16.7747 29.4893L2.13627 18.399Z" stroke=""/>
              <defs>
